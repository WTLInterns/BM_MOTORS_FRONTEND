...
import { Circle, CheckCircle, Wrench, Target } from "lucide-react";
    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Premium tyre brands, expert fitment, balancing, and alignment services. Ensure safety and performance with genuine tyres.
              </motion.p>
            ...
            >
              <Image 
                src="/images/Tyres1.jpg" 
                alt="Car Tyres and Wheels" 
                fill 
      ...
      <section id="services" className="max-w-7xl mx-auto px-4 py-24">
        <motion.div
          ...
          variants={fadeInUp}
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Our Tyre Services</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Complete wheel care solutions</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { 
              ...
              items: ["All premium brands", "Expert fitment", "Warranty included"] 
            },
            { 
              icon: <Wrench className="w-8 h-8 text-blue-600" />, 
              title: "Wheel Balancing", 
              items: ["Computerized balancing", "Vibration elimination", "Extended tyre life"] 
            },
            { 
              icon: <Target className="w-8 h-8 text-blue-600" />, 
              title: "Wheel Alignment", 
              items: ["3D laser alignment", "Better fuel economy", "Improved handling"] 
            },
            { 
              icon: <Wrench className="w-8 h-8 text-blue-600" />, 
              title: "Puncture Repair", 
              items: ["Quick repair", "Tubeless solutions", "Reliable fixing"] 
            }
          ].map((service, i) => (
            <motion.div 
              key={i} 
              className="bg-white border border-gray-200 rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 relative overflow-hidden"
      ...
      <section className="bg-gradient-to-br from-gray-50 to-blue-50 py-24">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">When to Replace Your Tyres</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Safety first - know when to change your tyres</p>
          </motion.div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-24">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Need New Tyres or Wheel Service?
            </motion.h3>
            ...
            >
              Premium tyres with expert installation
            </motion.p>
