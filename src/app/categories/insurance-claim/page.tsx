    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                End-to-end assistance for cashless claim settlement and repairs. We handle all paperwork and coordination with insurance companies.
              </motion.p>
            ...
            >
              <Image 
                src="/images/insurance-claim1.webp" 
      ...
      <section id="services" className="max-w-7xl mx-auto px-4 py-24">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Hassle-free claim processing</p>
        </motion.div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { icon: <Phone className="w-8 h-8 text-blue-600" />, title: "Claim Intimation", desc: "Quick claim registration and survey appointment coordination" },
            { icon: <FileText className="w-8 h-8 text-blue-600" />, title: "Documentation", desc: "Complete paperwork handling and estimate approvals" },
            { icon: <Wrench className="w-8 h-8 text-blue-600" />, title: "Repair & Delivery", desc: "Quality repairs and timely vehicle delivery" }
          ].map((service, i) => (
            <motion.div 
              key={i} 
