...
import { Wrench, Settings, Zap, Battery, CheckCircle } from "lucide-react";
    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Complete mechanical care for your car with expert technicians and genuine parts. From routine maintenance to complex repairs.
              </motion.p>
      ...
      <section id="services" className="max-w-7xl mx-auto px-4 py-24">
        <motion.div
          ...
          variants={fadeInUp}
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Our Mechanic Services</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Expert mechanical solutions for all car models</p>
        </motion.div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: <Settings className="w-8 h-8 text-blue-600" />, title: "Periodic Service", desc: "Engine oil changes and routine maintenance" },
            { icon: <Wrench className="w-8 h-8 text-blue-600" />, title: "Brake & Suspension", desc: "Complete brake and suspension overhauls" },
            { icon: <Zap className="w-8 h-8 text-blue-600" />, title: "Engine Diagnostics", desc: "Advanced troubleshooting and repairs" },
            { icon: <Battery className="w-8 h-8 text-blue-600" />, title: "Electricals", desc: "Battery checks and electrical repairs" }
          ].map((service, i) => (
            <motion.div 
              key={i} 
