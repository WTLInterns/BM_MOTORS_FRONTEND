...
import { Sparkles, Shield, CheckCircle, Wrench, Palette } from "lucide-react";
import Image from "next/image";

export default function DetailingCategoryPage() {
    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Deep cleaning and protection services to restore showroom shine. Interior and exterior perfection guaranteed.
              </motion.p>
      ...
      <section id="services" className="max-w-7xl mx-auto px-4 py-24">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Complete car care and protection</p>
        </motion.div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { icon: <Wrench className="w-8 h-8 text-blue-600" />, title: "Interior Deep Clean", desc: "Steam wash and sanitization" },
            { icon: <Sparkles className="w-8 h-8 text-blue-600" />, title: "Exterior Polish", desc: "Waxing, polishing, and sealants" },
            { icon: <Shield className="w-8 h-8 text-blue-600" />, title: "Ceramic Coating", desc: "Long-term paint protection" }
          ].map((service, i) => (
            <motion.div 
              key={i} 
      ...
      <section className="max-w-7xl mx-auto px-4 py-24">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Premium detailing packages available
            </motion.p>
