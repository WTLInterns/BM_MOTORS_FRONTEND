    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Fast, fair scrap evaluation with complete paperwork support and doorstep pickup. Get the best price for your old vehicle.
              </motion.p>
              ...
              >
                <motion.a 
                  ...
                  className="relative group bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold py-4 px-9 rounded-xl transition-all transform hover:scale-105 shadow-2xl hover:shadow-orange-500/30"
      ...
      <section id="process" className="max-w-7xl mx-auto px-4 py-24">
        <motion.div
          ...
          variants={fadeInUp}
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Simple Scrapping Process</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">We make it easy and profitable</p>
        </motion.div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { icon: <Search className="w-8 h-8 text-blue-600" />, title: "On-Spot Assessment", desc: "Fair price evaluation at your location" },
            { icon: <FileText className="w-8 h-8 text-blue-600" />, title: "RTO Documentation", desc: "Complete paperwork assistance" },
            { icon: <Truck className="w-8 h-8 text-blue-600" />, title: "Free Pickup", desc: "Doorstep collection and eco-disposal" }
          ].map((step, i) => (
            <motion.div 
              key={i} 
              className="bg-white border border-gray-200 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 relative overflow-hidden text-center"
